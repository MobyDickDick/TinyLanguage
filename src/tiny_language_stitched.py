...
def _patch_json_stringify() -> None:
    registrar = getattr(_stdlib, "_StdLibRegistrar", None)
    ...
    def _json_stringify(self, value: Any) -> str:
        ...
        def convert(val: Any) -> Any:
            ...
            if isinstance(val, int) and val in self.runtime.heap:
                ...
                try:
                    ...
                    if isinstance(obj, _stdlib.deque):
            ...
            if isinstance(val, dict):
                ...
                try:
                    ...
                    _unmark_seen(marker)
            if isinstance(val, _stdlib.deque):
        ...
        return _stdlib.json.dumps(convert(value))

    registrar._json_stringify = _json_stringify


_patch_json_stringify()
