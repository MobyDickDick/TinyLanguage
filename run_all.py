...
COMMANDS: list[tuple[str, list[str]]] = [
    ...
    ("class_demo.tiny", [PYTHON, "tiny_language.py", "class_demo.tiny"]),
    ...
    ("concurrency_pipeline.tiny", [PYTHON, "tiny_language.py", "concurrency_pipeline.tiny"]),
    ("parallel_map.tiny", [PYTHON, "tiny_language.py", "parallel_map.tiny"]),
    ("heap_pointer_demo.tiny", [PYTHON, "tiny_language.py", "heap_pointer_demo.tiny"]),
    ("namespace_demo.tiny", [PYTHON, "tiny_language.py", "namespace_demo.tiny"]),
    ("operator_overloading_demo.tiny", [PYTHON, "tiny_language.py", "operator_overloading_demo.tiny"]),
