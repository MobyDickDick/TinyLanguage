...
- Mirror debugger control flow (queued commands, pauses, breakpoint hits) to a file by setting `TINYLANG_DEBUGGER_LOG=/tmp/tiny_debugger.log` (or any path). This is especially useful when stdout is reserved for the Debug Adapter Protocol stream.
