...
def compile_and_run(
    ...
    *,
    ...
    lint_destruct_call_outputs(stmts, src)  # Ensure destructuring captures all outputs
    lint_no_consecutive_definitions(stmts)  # Reject repeated definitions that shadow improperly
    lint_locals_used(stmts, src)  # Warn about unused locals at the top level
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if args.eval is not None:  # Inline code execution
        try:
