...
- **Additional ideas**: REPL with syntax highlighting, parser/evaluator fuzzing (Hypothesis), and LSP enhancements (autocomplete/hover for the VSCode extension). Autocomplete and hover are now wired through the VS Code helper commands.
